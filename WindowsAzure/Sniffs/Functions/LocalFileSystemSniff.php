...
/**
 * WindowsAzure_Sniffs_Functions_LocalFileSystemSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * WindowsAzure_Sniffs_Functions_LocalFileSystemSniff.
 *
 * Checks for the PHP-File API in file.
 *
 * @category  PHP
 * @package   PHP_CodeSniffer_WindowsAzure
 * @author    Gaurav Deshmukh <v-gadesh@microsoft.com>
...
class WindowsAzure_Sniffs_Functions_LocalFileSystemSniff extends
WindowsAzure_Sniffs_GenericRuleParser
{
    ...
    function __construct()
    {
        ...
        $this->message  = "Windows Azure platform does not guarantee local file ";
        $this->message .= "system persistence. Please consider storing local ";
        $this->message .= "files data to Windows Azure Storage.";
